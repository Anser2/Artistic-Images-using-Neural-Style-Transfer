...
content_image = Image.open("images/anser.jpg")
...
example = Image.open("images/style_img2.jpg")
example
...
content_image = np.array(Image.open("images/anser.jpg").resize((img_size, img_size)))
...
style_image =  np.array(Image.open("images/style_img2.jpg").resize((img_size, img_size)))
...
def train_step(generated_image, alpha=10, beta=40):
    ...
    # Clip the values of the generated image to be between 0 and 1
